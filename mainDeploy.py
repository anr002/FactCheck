...
from defineModel import create_model, FactorFiction, get_tokenizer
...
train_dataset = FactorFiction(train_df_augmented['text'], train_df_augmented['label'], tokenizer, max_seq_len)
val_dataset = FactorFiction(val_df_augmented['text'], val_df_augmented['label'], tokenizer, max_seq_len)
